...
class Dictation extends H5P.Question {
   ...
   */
  handleContextChanged(contextId) {
   ...
   */
  getScore() {
    return (this.params.behaviour.scoring.zeroMistakeMode) ?
   ...
   */
  buildxAPICRP(gapsVariations, complete = false) {
    let crp = [''];
